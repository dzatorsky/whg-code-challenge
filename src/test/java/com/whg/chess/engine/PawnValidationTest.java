...
@SpringBootTest
@DisplayName("Requirement #5.6, #5.7, #5.8: Pawn move rules")
class PawnValidationTest {
    ...
    @DisplayName("Requirement #5.8: The pawn can move one square forward diagonally if taking an opponent piece")
    ...
    @ParameterizedTest
    @CsvSource({
            "WHITE,E2,E3, Normal 1 square move ahead",
            "WHITE,E2,E4, 2 square move ahead from starting position",
            "BLACK,E7,E6, Normal 1 square move ahead",
            "BLACK,E7,E5, 2 square move ahead from starting position",
    })
    @DisplayName("Requirement #5.6: The pawn can move one or two squares forward on its first move (when not taking an opponent piece)")
    ...
    @ParameterizedTest
    @CsvSource({
            "WHITE,E4,E3, WHITE pawn on E4 is not allowed to move to E3",
            "WHITE,E4,E6, WHITE pawn on E4 is not allowed to move to E6",
            "WHITE,E4,E2, WHITE pawn on E4 is not allowed to move to E2",
            ...
            "BLACK,E4,E5, BLACK pawn on E4 is not allowed to move to E5",
            "BLACK,E4,E2, BLACK pawn on E4 is not allowed to move to E2",
            "BLACK,E4,E6, BLACK pawn on E4 is not allowed to move to E6",
    ...
    @DisplayName("Test 2 square move from initial position when blocked")
    ...
    private void validatePieceCaptured(String to, Board afterMove, Color color) {
        ...
        List<Square> blackPieces = afterMove.getSquaresWithPieces(getOppositeColor(color));
    ...
    private void setOpponentsPiece(Board board, String coordinates, Color color) {
        ...
        squareWithBlackKnight.setPiece(new Piece(PieceName.KNIGHT, getOppositeColor(color)));
    }
